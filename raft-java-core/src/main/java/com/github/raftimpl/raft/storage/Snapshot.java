...
public class Snapshot {
    ...
    /**
     * Opens files in the snapshot data directory, handling symbolic links by opening the actual file handles.
     * @return A map of file names to SnapshotDataFile objects, which contain the file names and file handles.
     */
