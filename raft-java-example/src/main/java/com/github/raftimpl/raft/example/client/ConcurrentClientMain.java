...
/**
 * implements a client for a distributed key-value store using the Raft consensus algorithm.
 * The client uses BRPC for communication with the Raft-based server. It supports concurrent read and write operations.
 * The main class initializes two thread pools to handle write and read operations separately and manages tasks submission.
 */
